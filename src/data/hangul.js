...
export const CONSONANTS_BASIC = [
  { char: 'ㄱ', roman: 'g/k', sound: 'giyeok', hint: 'Like "g" in "go" or "k" in "kite"', group: 1,
  ...
  { char: 'ㄴ', roman: 'n', sound: 'nieun', hint: 'Like "n" in "nose"', group: 1,
  ...
  { char: 'ㄷ', roman: 'd/t', sound: 'digeut', hint: 'Like "d" in "do" or "t" in "top"', group: 2,
  ...
  { char: 'ㄹ', roman: 'r/l', sound: 'rieul', hint: 'Between "r" and "l"', group: 2,
  ...
  { char: 'ㅁ', roman: 'm', sound: 'mieum', hint: 'Like "m" in "mom"', group: 3,
  ...
  { char: 'ㅂ', roman: 'b/p', sound: 'bieup', hint: 'Like "b" in "boy" or "p" in "pin"', group: 3,
    mnemonic: 'Looks like a bucket — both lips pop apart',
    articulation: 'Both lips press together then burst open (bilabial stop).' },
  { char: 'ㅅ', roman: 's', sound: 'siot', hint: 'Like "s" in "sun"', group: 4,
  ...
  { char: 'ㅇ', roman: 'ng/silent', sound: 'ieung', hint: 'Silent at start, "ng" at end', group: 4,
  ...
  { char: 'ㅈ', roman: 'j', sound: 'jieut', hint: 'Like "j" in "jam"', group: 5,
  ...
  { char: 'ㅊ', roman: 'ch', sound: 'chieut', hint: 'Like "ch" in "church"', group: 5,
...
export const CONSONANTS_DOUBLE = [
  { char: 'ㄲ', roman: 'kk', sound: 'ssang-giyeok', hint: 'Tense "k" sound', base: 'ㄱ',
  ...
  { char: 'ㄸ', roman: 'tt', sound: 'ssang-digeut', hint: 'Tense "t" sound', base: 'ㄷ',
  ...
  { char: 'ㅃ', roman: 'pp', sound: 'ssang-bieup', hint: 'Tense "p" sound', base: 'ㅂ',
    mnemonic: 'Doubled ㅂ — tense your throat for a sharp P',
    articulation: 'Glottis tightens, both lips pop with no air puff.' },
  { char: 'ㅆ', roman: 'ss', sound: 'ssang-siot', hint: 'Tense "s" sound', base: 'ㅅ',
  ...
  { char: 'ㅉ', roman: 'jj', sound: 'ssang-jieut', hint: 'Tense "j" sound', base: 'ㅈ',
